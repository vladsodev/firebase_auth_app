...
final _formKey = GlobalKey<FormState>();
  ...
  Widget build(BuildContext context) {
    ...
    final latestUserData = ref.watch(latestUserDataProvider);
    return Scaffold(
      appBar: AppBar(
      ...
      body: userData.when(
        data: (userData) {
          ...
          _firstNameController = TextEditingController(text: latestUserData?.firstName);
          _lastNameController = TextEditingController(text: latestUserData?.lastName);
          _emailController = TextEditingController(text: latestUserData?.email);
          _phoneNumberController = TextEditingController(text: latestUserData?.phoneNumber);
          _dateOfBirthController = TextEditingController(text: latestUserData?.dateOfBirth); // Строка
          return SafeArea(
            child: Padding(
              ...
              child: Form(
                ...
                child: Column(
                  children: [
                    ...
                    ElevatedButton(
                      onPressed: () => _updateUserData(userData!.uid),
