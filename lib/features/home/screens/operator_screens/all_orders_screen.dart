                          ...
                          if (constraints.maxWidth > 650) {
                            return GridView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return OrderCard(name: order.name, price: order.price, timestamp: order.timestamp, buyer: order.buyer, backgroundColor: const Color.fromARGB(255, 171, 203, 219));
                              }
                            );
                          } else {
                            return ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                final order = orderList[index];
                                return OrderCard(name: order.name, price: order.price, timestamp: order.timestamp, buyer: order.buyer, backgroundColor: Color.fromARGB(121, 223, 198, 196));
                              }
                            );
                          }
                        } 
